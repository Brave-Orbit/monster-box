...
const sections = [
  {
    ...
    title: (
      <>
        <span className="hidden lg:inline">Box of contents</span>
        <span className="lg:hidden">Contents</span>
      </>
    ),
  },
  { id: 'screencasts', title: 'Prepare Wood' },
  { id: 'resources', title: 'Paint' },
  { id: 'pricing', title: 'Assemble' },
  { id: 'author', title: 'Decorate' },  
]
